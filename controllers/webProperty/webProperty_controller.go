...
func GetWebPropertyRequirementCheck(rw http.ResponseWriter, r *http.Request, enc encoding.Encoder, params martini.Params) string {
	...
	if idStr != "" {
		...
		req.ID, err = strconv.Atoi(params["id"])
		if err != nil {
			return err.Error()
		}
	}
...
func CreateUpdateWebPropertyRequirementCheck(rw http.ResponseWriter, r *http.Request, enc encoding.Encoder, params martini.Params) string {
	var req webProperty_model.WebPropertyRequirement
	var err error
	...
	propID := r.FormValue("propertyID")
	if propID != "" {
		req.WebPropID, err = strconv.Atoi(propID)
	}

	reqID := r.FormValue("requirementID")
	if reqID != "" {
		req.RequirementID, err = strconv.Atoi(reqID)
	}

	compliance := r.FormValue("compliance")
	if compliance != "" {
		req.Compliance, err = strconv.ParseBool(compliance)
	}
...
func DeleteWebPropertyRequirementCheck(rw http.ResponseWriter, r *http.Request, enc encoding.Encoder, params martini.Params) string {
	var req webProperty_model.WebPropertyRequirement
	var err error
